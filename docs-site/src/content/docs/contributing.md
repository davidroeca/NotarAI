---
title: Contributing
description: Development setup, code style, and PR workflow for NotarAI.
---
...
[Node.js](https://nodejs.org/) (for prettier and docs-site). Install
...
7. Use the `/notarai-reconcile` Claude Code command or use your favorite coding
   agent to follow these reconciliation instructions
